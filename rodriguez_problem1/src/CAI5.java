...
public class CAI5
{
	...
	public static String readProblemType()
	{
		...
		System.out.println("Type 5: Random");
		System.out.println("Input problem type preferred: ");
		Scanner problem = new Scanner(System.in);
		int type = problem.nextInt();
	...
	public static void askQuestion(int num)
	{
		...
		for(int i = 1; i <= 10; i++)
		{
			...
			System.out.println(i + ") How much is " + randInt1 + " " + type + " " + randInt2 + "?");
